...
import "base/errors/LibNativeOrdersRichErrors.sol";
import "base/fixins/FixinCommon.sol";
import "base/storage/LibNativeOrdersStorage.sol";
import "base/features/interfaces/INativeOrdersEvents.sol";
import "base/features/libs/LibSignature.sol";
import "base/features/libs/LibNativeOrder.sol";
import "base/features/native_orders/NativeOrdersCancellation.sol";


/**
 * @title Native Orders Settlement Without Protocol Fees
 * @author bayu <bayu@risedle.com> <https://github.com/pyk>
 * @notice NativeOrderSettlement without protocol fees
 */
abstract contract NativeOrdersSettlementWithoutProtocolFees is
    INativeOrdersEvents,
